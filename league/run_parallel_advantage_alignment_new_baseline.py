...
league_name = 'league_advantage_alignment_new_baseline_2024_04_26'
...
def get_name_pairs():
    ...
    combinations = get_combinations('advantage_alignment_new_baseline', all_agent_loaders, named_all_agent_loaders, hp)
    name_pairs = []
